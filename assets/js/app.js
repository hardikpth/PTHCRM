...
function unrestrictedQuotation(q){return ['approval_pending','approved','approval_rejected'].includes(q.status)?{...q,previousApprovalStatus:q.previousApprovalStatus||q.status,status:'review'}:q;}
let savedQuotations = (() => {
